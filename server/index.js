...
// Простая загрузка .env (без зависимостей): KEY=VALUE построчно.
// Так ключ не нужно вводить в терминале каждый раз — положи его в server/.env
loadEnv();
...
function loadEnv() {
  try {
    ...
    // .env необязателен — молча игнорируем
  }
}
